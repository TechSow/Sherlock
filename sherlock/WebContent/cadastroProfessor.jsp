		...
		<form action="controller" method="POST" class="form login">
			...
			<div class="form-group">
				<label for="exampleInputEmail1">Usuario</label> <input
					...
					aria-describedby="emailHelp" placeholder="Apenas Email!">
			</div>
			
			<button type="submit" class="btn btn-primary">Tornar usuario Professor</button>


		<p class="text--center">
			 <a href="home.jsp">Voltar a home</a>
			<svg class="icon">
