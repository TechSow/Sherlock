  ...
  <div class="grid">
    ...
    <form action="controller" method="POST" class="form login">
      ...
      <div class="form__field">
        ...
        <input id="login__username" type="text" name="emailOuApelido" class="form__input" placeholder="Email ou Apelido" required>
      </div>
	...
	<p class="text--center">Esqueceu a senha? <a href="recuperarSenha.jsp"> Recupere-a </a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
  </div>
