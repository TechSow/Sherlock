...
public class EmailSender {
	...
	final String username = "technology.sow";
...
//		email.setAuthentication(this.myEmail, this.password);
//		email.setSSLOnConnect(true);
//		
//		try {
//			email.setFrom(this.myEmail);
//			email.setSubject("Código de senha");
//			email.setMsg("o seu código é"+code);
