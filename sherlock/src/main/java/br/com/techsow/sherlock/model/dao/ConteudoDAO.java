...
public class ConteudoDAO extends BaseDAO implements IConteudoRepository {
	...
	public ArrayList<Conteudo> getConteudoFromMateriaId(int id_materia) throws Exception {
		...
		stmt = conn.prepareStatement(
				"select ID_CONTEUDO, TITULO, URL_PDF, HASBOT from ts_t_materia_conteudo inner join ts_t_CONTEUDO on TS_T_MATERIA_CONTEUDO.ID_CONTEUDO = TS_T_CONTEUDO.ID_CONTEUDO where ts_t_materia_conteudo.id_materia = ? ORDER BY ORDEM");
